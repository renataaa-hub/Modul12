            ...
            <div class="row justify-content-center">
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="age" class="form-label">Age</label>label">Age</label>

                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="age" id="age" value="{{old('age')}}"
